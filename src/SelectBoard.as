package
{
	...
	public class SelectBoard extends Sprite
	{
		...
		public function SelectBoard()
		{
			...
			var timeLabel:TextField = Utils.getLabel("时间", 0, 50, 14);
			...
			timeInput.x = 0; 
			timeInput.y = timeLabel.y + 16;
			this.addChild(timeInput);
			
			var xLabel:TextField = Utils.getLabel("x:", 0, timeLabel.y+50, 14);
			...
			xInput.x = 0; 
			xInput.y = xLabel.y + 16;
			this.addChild(xInput);
			
			var triggerLabel:TextField = Utils.getLabel("触发时间", 0, xLabel.y+50, 14);
			...
			triggerInput.x = 0; 
			triggerInput.y = triggerLabel.y + 16;
